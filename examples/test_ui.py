...
Creates a synthetic frame and shows the verification interface.
"""

import numpy as np
from lib.annotation import create_ellipsoid_params, verify_with_ui, AnnotationStatus
...
if __name__ == "__main__":
    ...
    print("It will create a synthetic test frame and open the verification window.\n")
